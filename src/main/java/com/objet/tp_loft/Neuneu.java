...
abstract class Neuneu extends Element {
	...
	public void marcher(int caseCibleX, int caseCibleY) {
		...
		//voir si on rajoute un test de sortie de Loft ou si on considère que caseCible est tjs dans le loft
	...
	public void manger(Nourriture bouffe) {
		...
		//test de la présence de ce type de bouffe dans la liste de ce qu'il peut manger
		...
		//enlever valeur sur case
			...
			//enlever valeur sur case: on supprime la présence de nourriture sur cette case
